...
# Answer 1
# To Display the product details (product_class_code, product_id, product_desc, product_price,) as per the following criteria and sort them in descending order of category:

SELECT * FROM PRODUCT ;

SELECT PRODUCT_CLASS_CODE AS product_class_code,
PRODUCT_DESC AS product_price ,
...
WHERE ad.PINCODE NOT like '%0%' AND oh.ORDER_STATUS='Shipped'
-- Orders that are shipped to areas with pincode that does not contain 0 
ORDER by 
